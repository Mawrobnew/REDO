...
export default function M_ChangeStatus() {
    ...
    if (!isOpen) return (
        <button onClick={() => setIsOpen(true)} id='btnModalChangeStatus'><FontAwesomeIcon icon={faUserSlash} size='1x'/></button>
    )
    return (
        <div>
            <div className='wrapper' onClick={()=>{setIsOpen(false)}}/>
            <div className='window'>
                <p className='title'>Desactivar beneficiario</p>
